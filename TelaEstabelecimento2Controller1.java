 ...
 * @author arthu
 */
public class TelaEstabelecimento2Controller1 implements Initializable {
    ...
    private void handleBotFrame1(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("ProdutosEstabelecimento_1.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
    ...
    private void handleBotFrame2(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("Entrerimento_1.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
    
    @FXML
    private void handleBotFrame3(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("Promoções_1.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
    //-------------------------------------------------------
}
