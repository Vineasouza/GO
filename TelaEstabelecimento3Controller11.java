 ...
 * @author arthu
 */
public class TelaEstabelecimento3Controller11 implements Initializable {
    ...
    private void handleBotFrame1(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("ProdutosEstabelecimento_1_1.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
    @FXML
    
    private void handleBotFrame2(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("Entrerimento_1_1.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
    @FXML
    private void handleBotFrame3(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("Promoções_1_1.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
    //-------------------------------------------------------
}
