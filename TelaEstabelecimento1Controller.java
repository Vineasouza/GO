 ...
 * @author arthu
 */
public class TelaEstabelecimento1Controller implements Initializable {
    ...
    private void handleBotFrame1(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("ProdutosEstabelecimento.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
    
    @FXML
    private void handleBotFrame2(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("Entrerimento.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
    
    @FXML
    private void handleBotFrame3(ActionEvent event) throws IOException{
        AnchorPane a = (AnchorPane)FXMLLoader.load(getClass().getResource("Promoções.fxml"));
        anchorEst1.getChildren().setAll(a);
    }
